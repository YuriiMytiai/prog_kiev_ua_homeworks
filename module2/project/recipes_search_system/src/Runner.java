...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Initialization initialization = new Initialization(new File("src.//content.//products"),
                new File("src.//content//recipes")); // will create base with 2 identical recipes
        // cause one is parsed from json and another one from binary file, but both have an equal content
        ...
        */
        ...
        // let's save recipe to txt file:
        Recipe myRecipe = smallComplexityRecipes.getRecipes().get(0);
        myRecipe.saveToTxtFile("Recipe0.txt");

        // let's save recipe into binary format:
        myRecipe.saveToBinaryFile("Recipe0.ser");
